...
master_data =
  read_csv("./data/master_data.csv", na = c("NA", ".", ""))
...
adverse_data =
  read_csv("./data/t05xc.csv", na = c("NA", ".", "")) %>%   #placed NA for any missing data for this and following data sets
...
lab_test_data =
  read_csv("./data/t016.csv", na = c("NA", ".", "")) %>% 
